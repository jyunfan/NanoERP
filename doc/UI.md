...
# customer table 客戶資料表 : list and edit
...
# product table 產品資料 : list and edit
...
# order table 訂單資料 : list and edit

Left panel: 客戶名稱選單，上下移動時即時載入該客戶的訂單資料，按下Enter鍵跳到右邊，編輯該客戶的訂單資料。第一欄顯示客戶名稱，第二欄顯示該客戶的訂單(order)數目(如果沒有訂單，或是訂單數目為0，就不顯示數字）。
| 客戶名稱 | 訂單數目 |
| -------- | -------- |
| 張三     | 5        |
| 李四     |          |
...
| 1          | 5        | 2          | 10       | 3          | 15       |
| 4          | 20       |            |          |            |          |
清單顯示該客戶的常用產品，定義在 customer_freq_product，按 f1 可以新增產品，會跳出所有產品扣除目前已經加入的產品。按 del 可以刪除產品，修改會更新 customer_freq_product。當使用者修改數量，更新 order table。如果某個產品的數量為 0 ，刪除該訂單。
